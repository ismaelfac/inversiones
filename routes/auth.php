<?php
Route::resource('panel', 'DashboardController');

Route::get('portalwasi', 'PortalController@index');
...
Route::get('posts/create', [
    'uses' => 'Post\CreatePostController@create',
    'as' => 'posts.create',
]);

Route::post('posts/create', [
    'uses' => 'Post\CreatePostController@store',
    'as' => 'posts.store',
]);
