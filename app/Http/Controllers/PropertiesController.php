...
class PropertiesController extends Controller
{
	...
	static function create_Wasi(array $properties_wasi){
		...
		return Properties::create([
                ...
                'id_user' => $properties_wasi, array('id_user'),
                ...
                'country_label' => $properties_wasi, array('country_label'),
                'id_region' => $properties_wasi, array('id_region'),
                'region_label' => $properties_wasi, array('region_label'),
                'id_city' => $properties_wasi, array('id_city'),
                'city_label' => $properties_wasi, array('city_label'),
                'id_zone' => $properties_wasi, array('id_zone'),
                'zone' => $properties_wasi, array('zone'),
                'zone_label' => $properties_wasi, array('zone_label'),
                ...
                'id_unit_built_area' => $properties_wasi, array('id_unit_built_area'),
                'unit_built_area_label' => $properties_wasi, array('unit_built_area_label'),
                ...
                'stratum' => $properties_wasi, array('stratum'),
                ...
                'property_condition_label' => $properties_wasi, array('property_condition_label'),
                'id_status_on_page' => $properties_wasi, array('id_status_on_page'),
                'status_on_page_label' => $properties_wasi, array('status_on_page_label'),
                'map' => $properties_wasi, array('map'),
                ...
                'network_share' => $properties_wasi, array('network_share'),
                ...
                'rents_type_label' => $properties_wasi, array('rents_type_label'),
